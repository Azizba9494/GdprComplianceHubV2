          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
              <Button 
                ...
                title={!hasPermission('subprocessors', 'write') ? "Droits insuffisants pour créer de nouveaux enregistrements" : ""}
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      disabled={!hasPermission('subprocessors', 'write')}
                      title={!hasPermission('subprocessors', 'write') ? "Droits insuffisants pour modifier cet enregistrement" : "Modifier l'enregistrement"}
                    >
                    ...
                    <Button
                      ...
                      disabled={!hasPermission('subprocessors', 'write')}
                      title={!hasPermission('subprocessors', 'write') ? "Droits insuffisants pour supprimer cet enregistrement" : "Supprimer l'enregistrement"}
                    >
